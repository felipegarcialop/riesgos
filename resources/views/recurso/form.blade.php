<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('Objetivo') }}
            {{ Form::text('Objetivo', $recurso->Objetivo, ['class' => 'form-control' . ($errors->has('Objetivo') ? ' is-invalid' : ''), 'placeholder' => 'Objetivo']) }}
        ...
        <div class="form-group">
            {{ Form::label('id_tema') }}
            {{ Form::text('id_tema', $recurso->id_tema, ['class' => 'form-control' . ($errors->has('id_tema') ? ' is-invalid' : ''), 'placeholder' => 'Id Tema']) }}
            {!! $errors->first('id_tema', '<div class="invalid-feedback">:message</div>') !!}
        </div>
